...
for batchmap in os.listdir(data_path):
    ...
    stock_data_output = os.path.join(data_path, batchmap, "stockdata")
    ...
    daily_data_output = os.path.join(data_path, batchmap, "dailydata")
    ...
    best_stocks_path = os.path.join(data_path, batchmap, "batch.csv")  # Waar de resultaten worden gehaald
