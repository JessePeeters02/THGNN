...
topN = 1000  # Aantal aandelen om te selecteren
output_path = os.path.join(base_path, "data", "testbatch_1000", f"top_{topN}_stocks.csv")  # Waar de resultaten worden opgeslagen
