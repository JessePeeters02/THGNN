...
for batchmap in os.listdir(data_path):
    ...
    relation_path = os.path.join(data_path, batchmap, "relation_dynamiSE")
    os.makedirs(relation_path, exist_ok=True)
    snapshot_path= os.path.join(data_path, batchmap, "intermediate_snapshots")
    os.makedirs(snapshot_path, exist_ok=True)
    data_train_predict_path = os.path.join(data_path, batchmap, "data_train_predict_DSE")
    os.makedirs(data_train_predict_path, exist_ok=True)
    daily_stock_path = os.path.join(data_path, batchmap, "daily_stock_DSE")
